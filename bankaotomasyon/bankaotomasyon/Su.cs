...
namespace bankaotomasyon
{
    public partial class Su : Form
    {
        ...
        private void Su_Load(object sender, EventArgs e)
        {
            ...
            while (dr2.Read())
            {
                fatura = Convert.ToInt32(dr2[10].ToString());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand Fatura = new SqlCommand("update musteri set su = '0' where kullaniciAdi='" + kullaniciAdi + "' or refKodu = '" + referanskodu + "'");
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            islemekle.Parameters.AddWithValue("@yapilanislem", "Ödeme: Su Faturası");
                            ...
                            islemekleENG.Parameters.AddWithValue("@yapilanislem", "Payment: Water");
