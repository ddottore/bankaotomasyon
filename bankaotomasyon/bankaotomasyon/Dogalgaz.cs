...
namespace bankaotomasyon
{
    public partial class Dogalgaz : Form
    {
        ...
        public void metinYazdir()
        {
            ...
            this.Text = Localization.Dogalgaz;
        ...
        private void Dogalgaz_Load(object sender, EventArgs e)
        {
            metinYazdir();
            ...
            while (dr2.Read())
            {
                fatura = Convert.ToInt32(dr2[11].ToString());
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand Fatura = new SqlCommand("update musteri set dogalgaz = '0' where kullaniciAdi='" + kullaniciAdi + "' or refKodu = '" + referanskodu + "'");
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            islemekle.Parameters.AddWithValue("@yapilanislem", "Ödeme: Doğalgaz Faturası");
                            ...
                            islemekleENG.Parameters.AddWithValue("@yapilanislem", "Payment: Natural Gas");
